    ...
    <div className="dashboard">
      ...
      <div className="sidebar">
        ...
        <ul>
          {userRole === 'admin' && (
            <>
              <li><button className="action-btn">Gestion des utilisateurs</button></li>
              <li><button className="action-btn">Rapports système</button></li>
              <li><button className="action-btn">Gestion des cours</button></li>
            </>
          )}

          {userRole === 'enseignant' && (
            <>
              <li><button className="action-btn">Mes cours</button></li>
              <li><button className="action-btn">Notes des étudiants</button></li>
            </>
          )}
          ...
          {userRole === 'apprenant' && (
            <>
              ...
              <li><button className="action-btn">Mes notes</button></li>
            </>
          )}
        </ul>
